    ...
    try:
        while True:
            if Date_Time_Userbot_teletips.is_connected:
                ...
                await Date_Time_Userbot_teletips.update_profile(bio = f"{Emojis_teletips} {Quotes_teletips}" , last_name = f"Bunda ren | ⏰{Time_teletips}")
                await Date_Time_Userbot_teletips.set_profile_photo(photo="https://telegra.ph/file/304178714796efbaf3da6.jpg")
